...
def get_embedding(path, training, testing, validation, lr, dim, fn, margin):
    ...
    if "dbpedia" in path:
        ...
        dbmodel.save_to_directory('model_complete_dbpedia_test/dbpedia_transe_model')
    ...
    if "lmdb" in path:
        ...
        # lmmodel.plot()
        lmmodel.save_to_directory('model_complete_lmdb_test/lmdb_transe_model')
...
def choose(path):
    ...
    #                 mrr, hit10 = evluate_model(path, training, testing, validation)
                    ...
                    # print(t_res)
                    # ans.append(t_res)
    get_embedding(path, training, testing, validation, 0.01, 100, 2, 1)
...
if __name__ == '__main__':
    ...
    print("ESBM Elapsed time = ", elapsed_time)
