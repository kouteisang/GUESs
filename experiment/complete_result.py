...
def store(top_k, type, id, k, m, name):
    ...
    folder_path = os.path.join(root, "res_data", 'esbm_plus_test', folder_name, name)
...
def get_complete_result(name, k, m, type):
    ...
    if name == "lmdb":
        ...
        if type == "transe":
            ...
            model_path = os.path.join(root,"embedding","model_complete_lmdb_test","lmdb_transe_model","trained_model.pkl")
    ...
    if name == "dbpedia":
        ...
        if type == "transe":
            ...
            model_path = os.path.join(root,"embedding","model_complete_dbpedia_test","dbpedia_transe_model","trained_model.pkl")
